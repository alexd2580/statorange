...
#define I3_IPC_EVENT_WORKSPACE ((uint32_t)(I3_IPC_EVENT_MASK | 0))

/* The output event will be triggered upon changes in the output list */
#define I3_IPC_EVENT_OUTPUT ((uint32_t)(I3_IPC_EVENT_MASK | 1))

/* The output event will be triggered upon mode changes */
#define I3_IPC_EVENT_MODE ((uint32_t)(I3_IPC_EVENT_MASK | 2))

/* The window event will be triggered upon window changes */
#define I3_IPC_EVENT_WINDOW ((uint32_t)(I3_IPC_EVENT_MASK | 3))

/** Bar config update will be triggered to update the bar config */
#define I3_IPC_EVENT_BARCONFIG_UPDATE ((uint32_t)(I3_IPC_EVENT_MASK | 4))
